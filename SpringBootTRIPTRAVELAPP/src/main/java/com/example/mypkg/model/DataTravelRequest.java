...
//@Entity
//@Table(name = "DataTravelRequest")
//@JsonIgnoreProperties(ignoreUnknown = true)

public class DataTravelRequest {
    //@Id
...
//    private Long empId;
    ...
    public DataTravelRequest() {
    }

    public DataTravelRequest(Long id, String dateOfTravel, String travelFor, String project, String businessUnit, String organisation, String trip, String tripDescription, String location, String applyFor, String other, String foreignExchange) {
        this.id = id;
